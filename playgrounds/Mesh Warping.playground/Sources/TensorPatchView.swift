            ...
            shape.identity.apply { commands, state in
                ...
                case .close:
                    ...
                    if !z.x.almostZero() || !z.y.almostZero() {
                        addCurves(TensorPatch(self.p0, self.p1, self.p2, self.p3, self.p4, self.p5, self.p6, self.p7, self.p8, self.p9, self.p10, self.p11, self.p12, self.p13, self.p14, self.p15, state.last, state.start))
                    }
                    if !flag {
                        path.append(.close)
                        flag = true
                    }
                case let .line(p1): addCurves(TensorPatch(self.p0, self.p1, self.p2, self.p3, self.p4, self.p5, self.p6, self.p7, self.p8, self.p9, self.p10, self.p11, self.p12, self.p13, self.p14, self.p15, state.last, p1))
                case let .quad(p1, p2): addCurves(TensorPatch(self.p0, self.p1, self.p2, self.p3, self.p4, self.p5, self.p6, self.p7, self.p8, self.p9, self.p10, self.p11, self.p12, self.p13, self.p14, self.p15, state.last, p1, p2))
                case let .cubic(p1, p2, p3): addCurves(TensorPatch(self.p0, self.p1, self.p2, self.p3, self.p4, self.p5, self.p6, self.p7, self.p8, self.p9, self.p10, self.p11, self.p12, self.p13, self.p14, self.p15, state.last, p1, p2, p3))
                }
            }
