...
public class StrokeView: NSView, NSGestureRecognizerDelegate {
    ...
    public override func draw(_ dirtyRect: NSRect) {
        ...
        if let context = NSGraphicsContext.current()?.cgContext {
            ...
            let path: SDPath = [.move(p0), .cubic(p1, p2, p3)]
...
//            for points in QuadBezierFitting([p0, p1, p2, p3]) {
//                switch points.count {
//                case 2:
//                    let path: SDPath = [.move(points[0]), .quad(points[1], points[2])]
//                    context.addPath(path.cgPath)
//                    context.strokePath()
//                case 3:
//                    let path: SDPath = [.move(points[0]), .cubic(points[1], points[2], points[3])]
//                    context.addPath(path.cgPath)
//                    context.strokePath()
//                default: break
//                }
