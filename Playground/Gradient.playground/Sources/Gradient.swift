...
public func sampleImage1(width: Int, height: Int) -> Image<ARGB32ColorPixel> {
...
public func sampleImage2(width: Int, height: Int) -> Image<ARGB32ColorPixel> {
...
public func sampleImage3(width: Int, height: Int) -> Image<ARGB32ColorPixel> {
