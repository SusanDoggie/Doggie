...
public func linearGradient(width: Int, height: Int) -> Image<ARGB32ColorPixel> {
    ...
    context.scale(x: Double(width) / 300, y: Double(height) / 300)
...
public func linearGradient_gpu(width: Int, height: Int) -> CIImage {
    ...
    context.drawLinearGradient(colorSpace: .sRGB, stops: [stop1, stop2], start: Point(x: 50, y: 50), end: Point(x: 250, y: 250), startSpread: .pad, endSpread: .pad)
    
    return context.image
}

public func radialGradient_gpu(width: Int, height: Int) -> CIImage {
    ...
    context.drawRadialGradient(colorSpace: .sRGB, stops: [stop1, stop2], start: Point(x: 100, y: 150), startRadius: 0, end: Point(x: 150, y: 150), endRadius: 100, startSpread: .pad, endSpread: .pad)
    
    return context.image
}

public func linearGradient2_gpu(width: Int, height: Int) -> CIImage {
    ...
    context.draw(shape: Shape(ellipseIn: Rect(x: 20, y: 20, width: width - 40, height: height - 40)), winding: .nonZero, gradient: gradient, colorSpace: .sRGB)
    
    return context.image
}

public func radialGradient2_gpu(width: Int, height: Int) -> CIImage {
