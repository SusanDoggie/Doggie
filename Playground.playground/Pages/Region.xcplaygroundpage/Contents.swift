...
(path2 + ellipse2).preview()

region3.union(region4).preview()
region3.intersection(region4).preview()
region3.subtracting(region4).preview()
region4.subtracting(region3).preview()
region3.symmetricDifference(region4).preview()
...
(r_square.shape + r_circle.shape).preview()

r_square.union(r_circle).preview()
r_square.intersection(r_circle).preview()
r_square.subtracting(r_circle).preview()
r_circle.subtracting(r_square).preview()
r_square.symmetricDifference(r_circle).preview()

var square3 = Shape(rect: Rect(x: 0, y: 0, width: 100, height: 100))
var square4 = Shape(rect: Rect(x:50, y: 10, width: 50, height: 80))

(square3 + square4).preview()

ShapeRegion(square3, winding: .nonZero).union(ShapeRegion(square4, winding: .nonZero)).preview()
ShapeRegion(square3, winding: .nonZero).intersection(ShapeRegion(square4, winding: .nonZero)).preview()
ShapeRegion(square3, winding: .nonZero).subtracting(ShapeRegion(square4, winding: .nonZero)).preview()
ShapeRegion(square4, winding: .nonZero).subtracting(ShapeRegion(square3, winding: .nonZero)).preview()
ShapeRegion(square3, winding: .nonZero).symmetricDifference(ShapeRegion(square4, winding: .nonZero)).preview()

var square5 = ShapeRegion(square3, winding: .nonZero).union(ShapeRegion(rect: Rect(x:50, y: 0, width: 100, height: 50)))

square5.subtracting(ShapeRegion(square4, winding: .nonZero)).preview()
...
ShapeRegion(circle2, winding: .nonZero).intersection(ShapeRegion(circle3, winding: .nonZero)).preview()

(circle4.shape + circle3).preview()

circle4.union(ShapeRegion(circle3, winding: .nonZero)).preview()
circle4.intersection(ShapeRegion(circle3, winding: .nonZero)).preview()
circle4.subtracting(ShapeRegion(circle3, winding: .nonZero)).preview()
ShapeRegion(circle3, winding: .nonZero).subtracting(circle4).preview()
circle4.symmetricDifference(ShapeRegion(circle3, winding: .nonZero)).preview()
...
(circle5 + circle6.identity + circle7.identity).preview()
ShapeRegion(circle5 + circle6.identity + circle7.identity, winding: .nonZero).preview()
(circle5 + circle6.identity + circle7.identity + circle8.identity).preview()
ShapeRegion(circle5 + circle6.identity + circle7.identity + circle8.identity, winding: .nonZero).preview()
...
ShapeRegion(path3, winding: .nonZero).preview()
...
ShapeRegion(path4, winding: .nonZero).preview()
...
ShapeRegion(path5, winding: .nonZero).preview()
