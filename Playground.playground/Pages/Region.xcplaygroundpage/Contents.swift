...
let region = ShapeRegion(path1, option: .nonZero)
let ellipse = Shape.Ellipse(path1.boundary)
let region2 = ShapeRegion(ellipse, option: .nonZero)
...
let region3 = ShapeRegion(path2, option: .nonZero)
let ellipse2 = Shape.Ellipse(path2.boundary)
let region4 = ShapeRegion(ellipse2, option: .nonZero)
...
ShapeRegion(Shape.Ellipse(x: 100, y: 100, rx: 100, ry: 100) + Shape.Ellipse(x: 110, y: 100, rx: 100, ry: 100) + Shape.Ellipse(x: 120, y: 100, rx: 100, ry: 100), option: .nonZero)
ShapeRegion(Shape.Ellipse(x: 100, y: 100, rx: 100, ry: 100) + Shape.Ellipse(x: 110, y: 100, rx: 100, ry: 100) + Shape.Ellipse(x: 120, y: 100, rx: 100, ry: 100), option: .evenOdd)
...
square.transform = SDTransform(SDTransform.Rotate(0.1))

let r_square = ShapeRegion(square, option: .nonZero).union(ShapeRegion(square2, option: .nonZero))
let r_circle = ShapeRegion(circle, option: .nonZero)
...
ShapeRegion(square3, option: .nonZero).union(ShapeRegion(square4, option: .nonZero))
ShapeRegion(square3, option: .nonZero).intersection(ShapeRegion(square4, option: .nonZero))
ShapeRegion(square3, option: .nonZero).subtracting(ShapeRegion(square4, option: .nonZero))
ShapeRegion(square4, option: .nonZero).subtracting(ShapeRegion(square3, option: .nonZero))
ShapeRegion(square3, option: .nonZero).symmetricDifference(ShapeRegion(square4, option: .nonZero))

let circle2 = Shape.Ellipse(x: 100, y: 100, rx: 100, ry: 100)
let circle3 = Shape.Ellipse(x: 149, y: 100, rx: 80, ry: 80)
let circle4 = ShapeRegion(circle2, option: .nonZero).union(ShapeRegion(circle3, option: .nonZero))

circle4.shape + circle3

circle4.union(ShapeRegion(circle3, option: .nonZero))
circle4.intersection(ShapeRegion(circle3, option: .nonZero))
circle4.subtracting(ShapeRegion(circle3, option: .nonZero))
ShapeRegion(circle3, option: .nonZero).subtracting(circle4)
circle4.symmetricDifference(ShapeRegion(circle3, option: .nonZero))
...
ShapeRegion(circle5 + circle6.identity + circle7.identity, option: .nonZero)
circle5 + circle6.identity + circle7.identity + circle8.identity
ShapeRegion(circle5 + circle6.identity + circle7.identity + circle8.identity, option: .nonZero)
...
ShapeRegion(path3, option: .nonZero)
...
ShapeRegion(path4, option: .nonZero)
...
ShapeRegion(path5, option: .nonZero)
...
let region5 = ShapeRegion(path6, option: .nonZero)
let region6 = ShapeRegion(path7, option: .nonZero)
