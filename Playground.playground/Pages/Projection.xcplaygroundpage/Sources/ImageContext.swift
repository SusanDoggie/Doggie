...
public func orthographicProject(width: Int, height: Int) -> Image<ARGB32ColorPixel> {
    ...
    let v0 = Vertex(position: Vector(x: 1, y: 1, z: -1) * matrix, color: c0)
    let v1 = Vertex(position: Vector(x: -1, y: 1, z: -1) * matrix, color: c1)
    let v2 = Vertex(position: Vector(x: -1, y: -1, z: -1) * matrix, color: c5)
    let v3 = Vertex(position: Vector(x: 1, y: -1, z: -1) * matrix, color: c3)
    let v4 = Vertex(position: Vector(x: 1, y: 1, z: 1) * matrix, color: c2)
    let v5 = Vertex(position: Vector(x: -1, y: 1, z: 1) * matrix, color: c4)
    let v6 = Vertex(position: Vector(x: -1, y: -1, z: 1) * matrix, color: c7)
    let v7 = Vertex(position: Vector(x: 1, y: -1, z: 1) * matrix, color: c6)
